...
def argument():
    ...
    parser.add_argument("--onefile", action="store_true", help="Create onefile installer. This option works only pyinstaller")
    parser.add_argument("-e", "--exe", action="store_true", help="Before create installer, make the specified .py file executable file")
